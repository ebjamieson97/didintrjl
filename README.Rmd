...
from time to time. You can do this directly from R using the brilliant [JuliaConnectoR](github.com/stefan-m-lenz/JuliaConnectoR) which is the package that **didintrjl** uses to interface with Julia.
